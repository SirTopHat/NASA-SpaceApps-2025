...
{
	/// <summary>
	/// Simple button controller for toggling NASA Data Card visibility
	/// Attach this to a button to enable/disable the NASA Data Card display
	/// </summary>
	public class NasaDataCardToggleButton : MonoBehaviour
	{
		[Header("References")]
		...
		private void Start()
		{
			...
			if (nasaDataCard == null)
				nasaDataCard = FindFirstObjectByType<GameUINasaDataCard>();
